...
import (
	...
	"github.com/Crawbl-AI/crawbl-backend/internal/controller"
	"github.com/Crawbl-AI/crawbl-backend/internal/indexes"
)
...
func main() {
	...
	if err := indexes.Setup(mgr); err != nil {
		ctrl.Log.WithName("setup").Error(err, "unable to register field indexes")
		os.Exit(1)
	}
	...
	ctrl.Log.WithName("setup").Info("starting userswarm operator")
