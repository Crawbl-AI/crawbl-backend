...
- `queue/` — River workers and NATS publishers for async work: usage analytics (River → ClickHouse), memory events (NATS), stale-message cleanup (River), and model-pricing cache.
